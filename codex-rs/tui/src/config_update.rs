...
pub(crate) async fn write_config_value(
    ...
    write_config_batch(request_handle, vec![replace_config_value(key_path, value)]).await
}
...
pub(crate) async fn write_upsert_config_value(
    ...
    write_config_batch(request_handle, vec![upsert_config_value(key_path, value)]).await
}
